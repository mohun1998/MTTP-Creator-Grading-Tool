...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.mtstudios.tech/mttpmx/css/ui.css">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Outlined" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
    <script src="http://www.mtstudios.tech/mttpmx/js/jquery.min.js"></script>
...
<body >
    ...
    <div class="titlebar">
        <img src="http://www.mtstudios.tech/mttpmx/images/mttp_logo.svg">
        ...
        <?php
            if(isset($_POST['submit'])) {
                ...
                echo $fullname;
                echo "</div><div class='separator'></div><a href='http://www.mtstudios.tech/mttpmx/'><div class='button' id='signOut'><div class='material-icons-outlined'>logout</div><div class='btnText'>Sign Out</div></div></a></div></button></div>";
                echo "</div>";
            }
        ?>
    </div>
    ...
    <div class="tablebody_container">
                  ...
                  <?php
                    if (isset($_POST['submit'])) {
                        for($i = 1; $i<=$count; $i++) {
                            ...
                            echo "<td> <input type='text' onClick='this.setSelectionRange(0, this.value.length);' id='OGAG_";
                            echo $i;
                            echo "' name='OGAG_";
                            echo $i;
                            echo "'> </td>";

                            echo "<td> <input type='text' onClick='this.setSelectionRange(0, this.value.length);' id='OGreason_";
                            echo $i;
                            echo "' name='OGreason_";
                            echo $i;
                            echo "'> </td>";
        ...
        <?php if (isset($_POST['submit'])) { echo "<script src='/mttpmx/js/index2.js'></script><script src='/mttpmx/PC/js/PC.js'></script><script src='/mttpmx/PCwr/js/PCwr.js'></script>";} ?>
</body>
</html>
